    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('limit_in_percentage', models.DecimalField(decimal_places=2, default=0, max_digits=4)),
                ('inherited_stock', models.DecimalField(decimal_places=2, default=0.1, max_digits=5)),
