...
class ProductionDivAdmin(ExportActionMixin, admin.ModelAdmin):
	...
	list_display = ('product_code','tanggal_blend','roast_date', 'nomor_set','komposisi', 'jenis_blend','weight', 'production_check_pass', 'cupping', 'qc_check_pass', 'pack_status', 'umur_blend')
	search_fields = ('tanggal_blend', 'jenis_blend')
	list_filter = (('tanggal_blend', PastDateRangeFilter),'komposisi',('roast_date', PastDateRangeFilter),'jenis_blend','cupping','production_check_pass', 'qc_check_pass',)
