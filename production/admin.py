...
class ProductionDivAdmin(ExportActionMixin, admin.ModelAdmin):
	...
	list_display = ('product_code','tanggal_blend','roast_date', 'nomor_set', 'jenis_blend','komposisi','weight', 'production_check_pass', 'cupping', 'qc_check_pass', 'pack_status', 'umur_blend')
